...
public class DataClassMapperFactory implements MapperFactory, StateReporter.Reportable {
    ...
    /**
     * Constructs a new instance of DataClassMapperFactory
     *
     * @param builder
     */
     ...
     * providing your own Builder class for subclasses of DataClassMapperFactory.<br>
     * <br>
     *
    ...
    /**
     * Use this builder to generate instances of DataClassMapperFactory with the
     ...
     *
     * <pre>
     * MapperFactory factory = new DataClassMapperFactory.Builder().build();
     * </pre>
     *
     * @author matt.deboer@gmail.com
     */
    public static class Builder extends MapperFactoryBuilder<DataClassMapperFactory, Builder> {
         ...
         *
         * @see
         * ma.glasnost.orika.impl.DataClassMapperFactory.MapperFactoryBuilder#
         * build()
         */
        @Override
