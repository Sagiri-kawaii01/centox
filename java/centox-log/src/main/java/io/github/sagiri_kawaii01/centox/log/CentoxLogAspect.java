...
import io.github.sagiri_kawaii01.centox.log.annotation.SaveLog;
...
public class CentoxLogAspect {
    ...
    @Pointcut(value = "(@within(io.github.sagiri_kawaii01.centox.log.annotation.Log) || @annotation(io.github.sagiri_kawaii01.centox.log.annotation.Log))")
    public void logCut() {
